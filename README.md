...
\n Core Features
Conversational AI Extraction: Uses OpenAI models to interpret natural text requests (e.g., "I want to book a meeting for Alek with the math teacher").
Fuzzy Name Matching: Handles typo-tolerant student and teacher name identification.
Dual Interface Options: Features both a web dashboard built with Streamlit and an interactive CLI version.
Automated Data Persistence: Real-time slot locking, availability updates, and Zoom link dispatch integrated with Excel backend handling.
